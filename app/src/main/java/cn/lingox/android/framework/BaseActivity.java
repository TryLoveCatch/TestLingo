...
public abstract class BaseActivity extends AppCompatActivity implements IUI, OnNetChangeListener {
    ...
    public void onBackPressed() {
        ...
        cn.lingox.android.framework.BaseFragment outer = (cn.lingox.android.framework.BaseFragment)fm.findFragmentById(R.id.content_frame);
        if(outer != null){
    ...
    protected void setContentFragment(Class<? extends cn.lingox.android.framework.BaseFragment> fragmentClass) {
    ...
    protected void setContentFragment(Class<? extends cn.lingox.android.framework.BaseFragment> fragmentClass, Bundle arguments) {
    ...
    protected void setContentFragment(Class<? extends cn.lingox.android.framework.BaseFragment> fragmentClass, Bundle arguments, int contentId) {
