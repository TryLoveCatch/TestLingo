...
public class CrashHandler implements UncaughtExceptionHandler {  
    ...
    public void uncaughtException(Thread thread, Throwable ex) {  
        if (!handleException(ex) && mDefaultHandler != null) {  
        	...
        	if(UtilManager.getInstance().mUtilActivity.getTopActivityFromStack()!=null){
        		showDialog();
        	}else{
        		showToast();
        		try {  
    ...
    private void showToast(){
    	new Thread() {  
            ...
            public void run() {  
                Looper.prepare();  
                T.show(mContext, "哎呀，出了些问题，请尝试重启程序", Toast.LENGTH_LONG);
                Looper.loop();  
            }  
        }.start(); 
    }
    ...
    private void showDialog(){
    	new Thread() {  
            ...
            public void run() {  
                Looper.prepare();  
                new AlertDialog.Builder(UtilManager.getInstance().mUtilActivity.getTopActivityFromStack())
                .setTitle("提示")
                .setCancelable(false)  
...
//						mApp.mUtilManager.mUtilActivity.getTopActivityFromStack().startActivity(tIntent);
				        ...
				        intent.setClassName(Constant.PACKAGE_NAME, Constant.LAUNCHER_NAME);  
    ...
    private String saveCrashInfo2File(Throwable ex) {  
        ...
        try {  
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {  
                File tFile  = UtilManager.getInstance().mUtilFile.getDirCrash();
                if(tFile==null){
                	return null;
                }
